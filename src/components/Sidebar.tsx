...
import { Home, MessageSquare, BarChart3, FileText, Settings, Download, Aperture, UserCircle, Lock, LockOpen, ChevronUp, FolderClosed, Footprints, Users, ArchiveRestore, Sparkles, Brain, Bot } from 'lucide-react'
    ...
    <>
      <aside className={`sidebar ${collapsed ? 'collapsed' : ''}`}>
        <nav className="nav-menu">
          ...
          <NavLink
            to="/persona"
            className={`nav-item ${isActive('/persona') ? 'active' : ''}`}
            title={collapsed ? '数字人格' : undefined}
          >
            <span className="nav-icon"><Brain size={20} /></span>
            <span className="nav-label">数字人格</span>
          </NavLink>

          <NavLink
                to="/ai-chat"
                className={`nav-item ${isActive('/ai-chat') ? 'active' : ''}`}
                title={collapsed ? 'AI聊天' : undefined}
              >
                <span className="nav-icon"><Bot size={20} /></span>
                <span className="nav-label">AI聊天</span>
              </NavLink>

              <NavLink
                to="/ai-settings"
                className={`nav-item ${isActive('/ai-settings') ? 'active' : ''}`}
                title={collapsed ? 'AI设置' : undefined}
              >
                <span className="nav-icon"><Settings size={20} /></span>
                <span className="nav-label">AI设置</span>
              </NavLink>
